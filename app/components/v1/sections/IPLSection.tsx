...
import { fetchIPLStandings, type IPLStandingRow } from "@/app/lib/v1/fetch-standings-client";
import { teamCode, teamColor } from "@/app/lib/v1/team-meta";
import { NewsTab } from "@/app/components/v1/NewsTab";
