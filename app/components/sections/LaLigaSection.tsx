...
export function LaLigaSection() {
  ...
  return (
    <>
      ...
      {activeTab === "upcoming" && (
        <FixturesTabPanel competitionShort="LAL" leagueCode={LEAGUE} accent={ACCENT} mode="upcoming" />
      )}

      {activeTab === "results" && (
        <FixturesTabPanel competitionShort="LAL" leagueCode={LEAGUE} accent={ACCENT} mode="results" />
      )}
