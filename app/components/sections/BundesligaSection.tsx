...
export function BundesligaSection() {
  ...
  return (
    <>
      ...
      {activeTab === "upcoming" && (
        <FixturesTabPanel competitionShort="BUN" leagueCode={LEAGUE} accent={ACCENT} mode="upcoming" />
      )}

      {activeTab === "results" && (
        <FixturesTabPanel competitionShort="BUN" leagueCode={LEAGUE} accent={ACCENT} mode="results" />
      )}
