...
export function Ligue1Section() {
  ...
  return (
    <>
      ...
      {activeTab === "upcoming" && (
        <FixturesTabPanel competitionShort="LIG" leagueCode={LEAGUE} accent={ACCENT} mode="upcoming" />
      )}

      {activeTab === "results" && (
        <FixturesTabPanel competitionShort="LIG" leagueCode={LEAGUE} accent={ACCENT} mode="results" />
      )}
      ...
      {activeTab === "teams" && <TeamsTabPanel competitionShort="LIG" accent={ACCENT} />}
    </>
  );
}
