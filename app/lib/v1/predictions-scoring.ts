import type { FootballFixtureRow } from "@/app/lib/v1/fetch-standings-client";
import type { Prediction, GroupPicks } from "@/app/lib/v1/predictions-types";
import { GROUP_LETTERS } from "@/app/lib/v1/wc2026-groups";
import { KO_BRACKET, KO_ROUND_POINTS, CHAMPION_POINTS } from "@/app/lib/v1/wc2026-ko-bracket";
import { teamCode } from "@/app/lib/v1/team-meta";
